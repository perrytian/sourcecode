...
public class XMLRegexReader {
   ...
   */
  public XMLRegexReader(String xmlString) throws IllegalArgumentException{
...
//  }
  ...
  public static void main(String[] args){
    //new XMLRegexReader("<ROOT>sss <PARENT>sss <CHILD>aaaa</CHILD>ss </PARENT>sss </ROOT>").getElementByMultiPath("ROOT[0]#PARENT#CHILD");
    //System.out.println(child);
    
    String test = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><SvcCont><Record><UserNumber>1860110</UserNumber></Record></SvcCont>";
    String elementString = new XMLRegexReader(test).getElementBySinglePath("SvcCont#Record#UserNumber");
    
    System.out.println(getElementText(elementString));
  }
}